        ...
        <div className="banner">
          <div className="firstBox">
            ...
            <div className="content">
              ...
              <p>
                We are committed to supporting your dedication to patient care.
                This panel provides you with quick access to appointments,
                medical records, patient history, and essential tools to
                streamline your workflow. Manage, monitor, and make informed
                decisions with ease. Thank you for being a part of our
                healthcare team.
              </p>
            </div>
          </div>
